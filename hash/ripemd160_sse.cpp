...
void sha256sse_checksum(uint32_t *d0, uint32_t *d1, uint32_t *d2, uint32_t *d3,
    ...
    // Access elements of __m128i using casting
    *d0 = __builtin_bswap32(((uint32_t *)&s[0])[3]);
    *d1 = __builtin_bswap32(((uint32_t *)&s[0])[2]);
    *d2 = __builtin_bswap32(((uint32_t *)&s[0])[1]);
    *d3 = __builtin_bswap32(((uint32_t *)&s[0])[0]);
}